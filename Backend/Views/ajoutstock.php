            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-area-chart"></i><a href="Gra_produit.html"> Graphiquestock</a></li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-sign-in"></i><a href="ajouterstock.php">Ajouter</a></li>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="ajouterstock" method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number"  name="nbrarticle" class="form-control" >
                                            </div>
                                            <div class="form-group">
