<?php
   ...
   $req ="select * from admine where id = $id";
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center">Modifier Admin </h3>
                                        </div>
                                        <hr>
                                        <form action="modifierdevPHPadmine.php" method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="password"  name="pass" value="<?php echo $Admin["pass"]?>" class="form-control" >
                                            </div>
                                            <div class="form-group">
                                                <label >Adresse</label>
                                                <input type="text"  name="adresse" value="<?php echo $Admin["adresse"]?>" class="form-control" >
                                            </div>
                                            <div class="form-group">
                                                <label >categorie</label>
                                                <input type="text"  name="categorie" value="<?php echo $Admin["categorie"]?>" class="form-control" >
                                            </div>
