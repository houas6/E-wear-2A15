...
<div id="right-panel" class="right-panel">
                                        ...
                                        <tr>
                                          ...
                                          ?>
                                                  <tr>
                                                      ...
                                                      <td> <a href="supprimerdevadmine.php?rep=<?php echo $ligne['ID'];?>"><button type="button" class="btn btn-outline-danger">Supprimer</button></a></td>
                                                      <td> <a href="modifierdevadmine.php?id=<?=$ligne["ID"]?>"><button type="button" class="btn btn-outline-info">modifier</button></a></td>
        ...
        <div>
            <button type="button" class="btn btn-primary btn-lg" style="margin-top:3%;margin-left:5%;border-radius: 5%;">
                <a href="ajoutadmin.php">Ajouter</a>
            </button>
            <button type="button" class="btn btn-primary btn-lg" style="margin-top:3%;margin-left:5%;border-radius: 5%;">
                <a href="tri.php">Tri</a>
            </button>
          </div>
